-- Schema completo e atualizado do banco de dados Supabase
-- Execute este SQL no SQL Editor do Supabase Dashboard
-- Criar tabela de empresas
CREATE TABLE
    IF NOT EXISTS public.companies (
...
CREATE TABLE
    IF NOT EXISTS public.employee_progress (
        id UUID DEFAULT gen_random_uuid () PRIMARY KEY,
...
CREATE POLICY "Companies are insertable by everyone" ON public.companies FOR INSERT
WITH
    CHECK (true);

DROP POLICY IF EXISTS "Companies are updatable by everyone" ON public.companies;

CREATE POLICY "Companies are updatable by everyone" ON public.companies FOR
UPDATE USING (true);

-- Políticas RLS para managers
DROP POLICY IF EXISTS "Managers are viewable by everyone" ON public.managers;

CREATE POLICY "Managers are viewable by everyone" ON public.managers FOR
SELECT
    USING (true);

DROP POLICY IF EXISTS "Managers are insertable by everyone" ON public.managers;

CREATE POLICY "Managers are insertable by everyone" ON public.managers FOR INSERT
WITH
    CHECK (true);

DROP POLICY IF EXISTS "Managers are updatable by everyone" ON public.managers;

CREATE POLICY "Managers are updatable by everyone" ON public.managers FOR
UPDATE USING (true);

-- Políticas RLS para employees
DROP POLICY IF EXISTS "Employees are viewable by everyone" ON public.employees;

CREATE POLICY "Employees are viewable by everyone" ON public.employees FOR
SELECT
    USING (true);

DROP POLICY IF EXISTS "Employees are insertable by everyone" ON public.employees;

CREATE POLICY "Employees are insertable by everyone" ON public.employees FOR INSERT
WITH
    CHECK (true);

DROP POLICY IF EXISTS "Employees are updatable by everyone" ON public.employees;

CREATE POLICY "Employees are updatable by everyone" ON public.employees FOR
UPDATE USING (true);

-- Políticas RLS para orders
DROP POLICY IF EXISTS "Orders are viewable by everyone" ON public.orders;

CREATE POLICY "Orders are viewable by everyone" ON public.orders FOR
SELECT
    USING (true);

DROP POLICY IF EXISTS "Orders are insertable by everyone" ON public.orders;

CREATE POLICY "Orders are insertable by everyone" ON public.orders FOR INSERT
WITH
    CHECK (true);

DROP POLICY IF EXISTS "Orders are updatable by everyone" ON public.orders;

CREATE POLICY "Orders are updatable by everyone" ON public.orders FOR
UPDATE USING (true);
...
CREATE POLICY "Videos are insertable by everyone" ON public.videos FOR INSERT
WITH
    CHECK (true);

DROP POLICY IF EXISTS "Videos are updatable by everyone" ON public.videos;

CREATE POLICY "Videos are updatable by everyone" ON public.videos FOR
UPDATE USING (true);
...
CREATE POLICY "Employee progress is viewable by everyone" ON public.employee_progress FOR
SELECT
    USING (true);

DROP POLICY IF EXISTS "Employee progress is insertable by everyone" ON public.employee_progress;

CREATE POLICY "Employee progress is insertable by everyone" ON public.employee_progress FOR INSERT
WITH
    CHECK (true);

DROP POLICY IF EXISTS "Employee progress is updatable by everyone" ON public.employee_progress;

CREATE POLICY "Employee progress is updatable by everyone" ON public.employee_progress FOR
UPDATE USING (true);
...
VALUES
    (
        'Introdução à Terapia Empresarial',
        'Conceitos básicos sobre terapia no ambiente corporativo',
    ...
    (
        'Gestão de Conflitos',
        'Como resolver conflitos entre equipes',
    ...
    (
        ...
        'Técnicas de comunicação eficaz no trabalho',
    ...
    (
        ...
        'Promovendo saúde mental no ambiente corporativo',
